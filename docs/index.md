...
- Connect the iPhone app to the Mac gateway through a user-owned Cloudflare Tunnel.
...
- [Privacy, beta data flow, and deletion](PRIVACY.md#beta-data-flow-at-a-glance)
