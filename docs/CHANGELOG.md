...
- Aligned the App Store screenshot checklist with the same fictional demo data and removed guidance that could expose a real local Mac path or local-web session detail.
