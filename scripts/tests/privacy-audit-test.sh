...
assert_rejected_without_echo "GitHub app token" "g""hs_0123456789abcdefghijklmnopqrstuvwxyz"
assert_rejected_without_echo "GitHub refresh token" "g""hr_0123456789abcdefghijklmnopqrstuvwxyz"
...
assert_rejected_without_echo "cloud access key" "AKIA""ABCDEFGHIJKLMNOP"
...
assert_rejected_without_echo "Slack user token" "xox""p-1234567890-abcdefghijklmnop"
...
assert_rejected_without_echo "test payment key" "s""k_test_0123456789abcdefghijklmnop"
assert_rejected_without_echo "restricted payment key" "r""k_live_0123456789abcdefghijklmnop"
...
assert_rejected_without_echo "PyPI token" "pypi-""0123456789abcdefghijklmnopqrstuvwxyzABCDEFGH"
assert_rejected_without_echo "Hugging Face token" "hf_""0123456789abcdefghijklmnopqrstuvwxyz"
assert_rejected_without_echo "SendGrid token" "SG.""0123456789abcdefghijklmnop.ABCDEFGHIJKLMNOPQRSTUVWX"
assert_rejected_without_echo "DigitalOcean token" "dop_v1_""0123456789abcdefghijklmnopqrstuvwxyzABCD"
assert_rejected_without_echo "age private key" "AGE-SECRET-KEY-1ABC""DEFGHIJKLMNOPQRSTUVWXYZ234567890"
assert_rejected_without_echo "PGP private key" "-----BEGIN PGP PRIVATE ""KEY BLOCK-----"
