...
final class SetupStatusTests: XCTestCase {
    ...
    func testSetupStatusLabelsAreUserFacing() {
        ...
        XCTAssertEqual(CodePilotSetupRequirement.screenRecordingMissing.statusLabel, "Optional")
        XCTAssertEqual(CodePilotSetupRequirement.accessibilityReady.statusLabel, "Ready")
        XCTAssertEqual(CodePilotSetupRequirement.accessibilityMissing.statusLabel, "Optional")
