...
Reverified on 2026-07-22. The read-only live presence audit still reports seven failures: the repository description, repository website field, GitHub Pages configuration, private vulnerability reporting, and the landing, privacy, and support URLs. GitHub issues #25 and #27 also remain open. These map to four launch-readiness settings that require maintainer access, one legal-content decision, and one unresolved release blocker:
